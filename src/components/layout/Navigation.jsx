...
import { Sun, Moon, Zap, LogOut, TrendingUp } from 'lucide-react';

const Navigation = ({ currentScreen, onScreenChange, isDarkMode, toggleTheme, onSignOut, isMobileMenuOpen, onToggleMobileMenu }) => {
    ...
    const navItems = [
        ...
        { id: 6, icon: <TrendingUp size={28} className="w-7 h-7" />, label: 'History' },
        ...
        <nav className="flex items-center justify-between px-6 py-4 bg-[var(--bg-primary)] border-b border-[var(--border)] sticky top-0 z-50">
            ...
            <div className="flex items-center gap-4">
                ...
                <button
                    ...
                    className="md:hidden p-2 text-[var(--text-secondary)] hover:text-[var(--accent)] transition-organic"
                >
