...
const CalendarView: React.FC<CalendarViewProps> = ({ sessions, onDeleteSession }) => {
          ...
          <div className="grid grid-cols-7 gap-4">
            {days.map(day => {
              ...
              return (
                <div 
                  key={day} 
                  className={`min-h-[140px] p-3 organic-shape border transition-organic group relative flex flex-col justify-between ${
                    isToday 
