...
The project uses Supabase. Ensure your database tables (`sessions`, `weekly_plan`, `profiles`) are created. See `database_schema.sql` for the setup script.

---

## 🤝 Contributing

Contributions are clear. Fork it, branch it, push it.
